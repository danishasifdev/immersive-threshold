...
const ThresholdScene = dynamic(() => import('@/components/3d/Scene'), { ssr: false });
const CustomCursor = dynamic(() => import('@/components/ui-custom/CustomCursor'), { ssr: false });
const NavigationDots = dynamic(() => import('@/components/ui-custom/NavigationDots'), { ssr: false });
...
const SECTION_NAMES = ['ORIGIN', 'IDEA', 'CONNECTION', 'SYSTEM', 'PRODUCT', 'IMPACT'];
  ...
  return (
    <>
      ...
      <main style={{ position: 'relative', zIndex: 2 }}>
        ...
        <SectionAxiom wireframe={controls.wireframe} onToggleWireframe={onToggleWireframe} />
        <SectionEdge wireframe={controls.wireframe} onToggleWireframe={onToggleWireframe} />
        <SectionForm
